...
var em_maps_provider_google = {
		...
		if( !this.loaded ){
			if ( jQuery('script#google-maps').length == 0 && ( typeof google !== 'object' || typeof google.maps !== 'object' ) ){
				...
				if( typeof EM.google_maps_api !== 'undefined' ){
					script.src = proto + '//maps.google.com/maps/api/js?v=quarterly&libraries=places&callback=em_maps_provider_google.init&key='+EM.google_maps_api;
				}else{
					script.src = proto + '//maps.google.com/maps/api/js?v=quarterly&libraries=places&callback=em_maps_provider_google.init';
				}
				document.body.appendChild(script);
	...
	map_infobox: function(marker, message, map) {
